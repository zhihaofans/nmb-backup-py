...
# Version:0.1
# Author:zhihaofans
# Github:https://github.com/zhihaofans/nmb-backup-python
# PythonVersion:2.x
import urllib
import urllib2
import cookielib
...
def getjson(_tid,_page):
    headers={
        ...
        'User-Agent':'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/51.0.2704.103 Safari/537.36'  #模拟浏览器UA
    }
